...
measurement.plot_multiple(E_times, E_z_t, labels, "time [s]", "E_z [V/m]", "Transmitted E_z-fields for various eps_r", "E_z_t_eps_r")
measurement.plot_multiple(E_times, E_z_r, labels, "time [s]", "E_z [V/m]", "Reflected E_z-fields for various eps_r", "E_z_r_eps_r")
measurement.plot_multiple(H_times, H_x_t, labels, "time [s]", "E_z [V/m]", "Transmitted H_x-fields for various eps_r", "H_x_t_eps_r")
measurement.plot_multiple(H_times, H_x_r, labels, "time [s]", "E_z [V/m]", "Reflected H_x-fields for various eps_r", "H_x_r_eps_r")
measurement.plot_multiple(H_times, H_y_t, labels, "time [s]", "E_z [V/m]", "Transmitted H_y-fields for various eps_r", "H_y_t_eps_r")
measurement.plot_multiple(H_times, H_y_r, labels, "time [s]", "E_z [V/m]", "Reflected H_y-fields for various eps_r", "H_y_r_eps_r")
...
measurement.plot_multiple([epsilons]*2, [T_meas, T_theory], ["measured T", "predicted T"], "eps_r [-]", "Relative amplitude [-]", "T coefficient for various eps_r", "TRcoeff_eps_r")